...
import time
from GNN.util.time import *
from GNN.util.env import *
...
class GDN(nn.Module):
    def __init__(self, edge_index_sets, node_num, dim=64, out_layer_inter_dim=256, input_dim=10, out_layer_num=1, topk=20, embedding = None):
        ...
        if embedding is not None:
            self.embedding.weight.data = torch.tensor(embedding).float()
    ...
    def forward(self, data, org_edge_index):
        ...
        for i, edge_index in enumerate(edge_index_sets):
            ...
            # TODO: modify the initialization of embeddings
