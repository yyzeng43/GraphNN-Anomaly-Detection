...
def get_f1_scores(total_err_scores, gt_labels, topk=1):
    ...
    final_topk_fmeas = eval_scores(total_topk_err_scores, gt_labels, 5000)

    return final_topk_fmeas

def get_val_performance_data(total_err_scores, normal_scores, gt_labels, topk=5):
    total_features = total_err_scores.shape[0]
...
def get_best_performance_data(total_err_scores, gt_labels, topk=10):
    ...
    final_topk_fmeas ,thresolds = eval_scores(total_topk_err_scores, gt_labels, 5000, return_thresold=True)
